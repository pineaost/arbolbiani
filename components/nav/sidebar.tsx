...
export function Sidebar() {
  ...
  return (
    <nav
      ...
      className="hidden md:fixed md:inset-y-0 md:left-0 md:z-20 md:flex md:w-56 md:flex-col md:border-r md:border-sakura-line md:bg-sakura-canvas md:px-4 md:py-8"
    >
